...
var docDefinition = {
	...
	content: [
		{
			section: ["SECTION 1", "Text in section."],
		},
		{
			...
			section: ["SECTION 2", "Text in section as landscape page."],
		},
		{
			header: null,
			footer: null,
			...
			section: ["SECTION 3", "Text in section as A7 page."],
		},
		{
			watermark: "inherit",
			pageSize: "A6",
			pageOrientation: "portrait",
			pageMargins: 5,
			section: ["SECTION 4", "Text in section as A6 page with margin."],
		},
		{
			...
			pageOrientation: "landscape",
			pageMargins: 10,
			section: ["SECTION 5", "Text in section as A6 landscape page with margin."],
		},
		{
			watermark: "inherit",
			pageSize: "inherit",
		...
		},
		{
			...
			section: ["SECTION 7", "Text in section with page definition as defined in document."],
		},
	],
};
